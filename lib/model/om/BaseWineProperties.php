...
abstract class BaseWineProperties extends BaseObject  implements Persistent {
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			$keys[0] => $this->getWineId(),
			$keys[1] => $this->getWinePropertyValueId(),
			$keys[2] => $this->getId(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[0], $arr)) $this->setWineId($arr[$keys[0]]);
		if (array_key_exists($keys[1], $arr)) $this->setWinePropertyValueId($arr[$keys[1]]);
