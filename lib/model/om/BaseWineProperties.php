...
abstract class BaseWineProperties extends BaseObject  implements Persistent {
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->wine_id = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
			$this->wine_property_value_id = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
			$this->resetModified();
	...
	{
		$pos = WinePropertiesPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			case 0:
				...
				break;
			case 1:
				return $this->getWineId();
				break;
			case 2:
				return $this->getWinePropertyValueId();
				break;
			default:
				return null;
				break;
	...
	{
		$keys = WinePropertiesPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getWineId(),
			$keys[2] => $this->getWinePropertyValueId(),
		);
		return $result;
	}
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			case 0:
				...
				break;
			case 1:
				$this->setWineId($value);
				break;
			case 2:
				$this->setWinePropertyValueId($value);
				break;
		} // switch()
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[1], $arr)) $this->setWineId($arr[$keys[1]]);
		if (array_key_exists($keys[2], $arr)) $this->setWinePropertyValueId($arr[$keys[2]]);
	}
