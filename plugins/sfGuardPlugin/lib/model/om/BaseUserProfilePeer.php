...
abstract class BaseUserProfilePeer {
	...
	const CLASS_DEFAULT = 'plugins.sfGuardPlugin.lib.model.UserProfile';

	/** the related TableMap class for this table */
	const TM_CLASS = 'UserProfileTableMap';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'UserId', 'FirstName', 'LastName', 'FacebookUid', 'Email', 'EmailHash', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'userId', 'firstName', 'lastName', 'facebookUid', 'email', 'emailHash', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::USER_ID, self::FIRST_NAME, self::LAST_NAME, self::FACEBOOK_UID, self::EMAIL, self::EMAIL_HASH, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'user_id', 'first_name', 'last_name', 'facebook_uid', 'email', 'email_hash', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'UserId' => 1, 'FirstName' => 2, 'LastName' => 3, 'FacebookUid' => 4, 'Email' => 5, 'EmailHash' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'userId' => 1, 'firstName' => 2, 'lastName' => 3, 'facebookUid' => 4, 'email' => 5, 'emailHash' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::USER_ID => 1, self::FIRST_NAME => 2, self::LAST_NAME => 3, self::FACEBOOK_UID => 4, self::EMAIL => 5, self::EMAIL_HASH => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'user_id' => 1, 'first_name' => 2, 'last_name' => 3, 'facebook_uid' => 4, 'email' => 5, 'email_hash' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(UserProfilePeer::FACEBOOK_UID);
		$criteria->addSelectColumn(UserProfilePeer::EMAIL);
		$criteria->addSelectColumn(UserProfilePeer::EMAIL_HASH);
	}
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		{
		  call_user_func($sf_hook, 'BaseUserProfilePeer', $criteria, $con);
		}
	...
	public static function doCountJoinsfGuardUser(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(UserProfilePeer::USER_ID, sfGuardUserPeer::ID, $join_behavior);
	...
	{
		return $withPrefix ? UserProfilePeer::CLASS_DEFAULT : UserProfilePeer::OM_CLASS;
	}
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseUserProfilePeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseUserProfilePeer', $values, $con))
      {
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseUserProfilePeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseUserProfilePeer', $values, $con, $pk);
    }
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseUserProfilePeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseUserProfilePeer', $values, $con))
      {
        return $sf_hook_retval;
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseUserProfilePeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseUserProfilePeer', $values, $con, $ret);
    }
	...
	{
	  return array(array('facebook_uid'), array('email'), array('email_hash'));
	}
	...
	static private function getMixerPreSelectHook($method)
	{
	  ...
	  {
	    return sprintf('BaseUserProfilePeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
	  }
