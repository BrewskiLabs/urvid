...
abstract class BasesfGuardUserProfilePeer {
	...
	/** the column name for the TYPE_LOGIN field */
	const TYPE_LOGIN = 'sf_guard_user_profile.TYPE_LOGIN';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'UserId', 'FirstName', 'LastName', 'FacebookUid', 'TypeLogin', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'userId', 'firstName', 'lastName', 'facebookUid', 'typeLogin', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::USER_ID, self::FIRST_NAME, self::LAST_NAME, self::FACEBOOK_UID, self::TYPE_LOGIN, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'user_id', 'first_name', 'last_name', 'facebook_uid', 'type_login', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'UserId' => 1, 'FirstName' => 2, 'LastName' => 3, 'FacebookUid' => 4, 'TypeLogin' => 5, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'userId' => 1, 'firstName' => 2, 'lastName' => 3, 'facebookUid' => 4, 'typeLogin' => 5, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::USER_ID => 1, self::FIRST_NAME => 2, self::LAST_NAME => 3, self::FACEBOOK_UID => 4, self::TYPE_LOGIN => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'user_id' => 1, 'first_name' => 2, 'last_name' => 3, 'facebook_uid' => 4, 'type_login' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(sfGuardUserProfilePeer::TYPE_LOGIN);
	}
