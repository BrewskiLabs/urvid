...
abstract class BasesfGuardUserPeer {
	...
	{
		// invalidate objects in WinesPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			// delete related Wines objects
			$criteria = new Criteria(WinesPeer::DATABASE_NAME);
			
			$criteria->add(WinesPeer::USER_ID, $obj->getId());
			$affectedRows += WinesPeer::doDelete($criteria, $con);
