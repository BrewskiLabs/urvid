...
abstract class BasesfGuardUserProfile extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the type_login field.
	 * @var        string
	 */
	...
	/**
	 * Get the [type_login] column value.
	 * 
	 * @return     string
	 */
	...
	public function setFacebookUid($v)
	{
		...
		if ($this->facebook_uid !== $v) {
			$this->facebook_uid = $v;
			$this->modifiedColumns[] = sfGuardUserProfilePeer::FACEBOOK_UID;
		}
	...
	/**
	 * Set the value of [type_login] column.
	 * 
	 * @param      string $v new value
	 * @return     sfGuardUserProfile The current object (for fluent API support)
	 */
	public function setTypeLogin($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->type_login !== $v) {
			$this->type_login = $v;
			$this->modifiedColumns[] = sfGuardUserProfilePeer::TYPE_LOGIN;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->type_login = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
			$this->resetModified();
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[5], $arr)) $this->setTypeLogin($arr[$keys[5]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(sfGuardUserProfilePeer::FACEBOOK_UID)) $criteria->add(sfGuardUserProfilePeer::FACEBOOK_UID, $this->facebook_uid);
		if ($this->isColumnModified(sfGuardUserProfilePeer::TYPE_LOGIN)) $criteria->add(sfGuardUserProfilePeer::TYPE_LOGIN, $this->type_login);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setTypeLogin($this->type_login);
