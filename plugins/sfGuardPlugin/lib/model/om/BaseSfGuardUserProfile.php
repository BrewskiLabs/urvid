...
abstract class BasesfGuardUserProfile extends BaseObject  implements Persistent {
	...
	public function setEmailHash($v)
	{
		...
		if ($this->email_hash !== $v) {
			$this->email_hash = $v;
			$this->modifiedColumns[] = sfGuardUserProfilePeer::EMAIL_HASH;
		}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(sfGuardUserProfilePeer::EMAIL_HASH)) $criteria->add(sfGuardUserProfilePeer::EMAIL_HASH, $this->email_hash);
